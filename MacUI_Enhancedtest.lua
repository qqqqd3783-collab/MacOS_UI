    ...
    function self:Tab(name, icon)
        ...
        Button.MouseButton1Click:Connect(function()
            for _, t in pairs(self.Tabs) do
                ...
                if t.Label then
                    t.Label.TextColor3 = Color3.fromRGB(60, 60, 65)
                else
                    t.Button.TextColor3 = Color3.fromRGB(60, 60, 65)
                end
                if t.Icon then
                    t.Icon.ImageColor3 = Color3.fromRGB(60, 60, 65)
                end
            ...
            colorBtn.MouseButton1Click:Connect(function()
                ...
                local function createSlider(name, value, yPos)
                    ...
                    local sliderKnob = create("Frame", {
                        ...
                        Position = UDim2.new(value / 255, -7, 0.5, -7),
                        BackgroundColor3 = Color3.fromRGB(255, 255, 255),
                        BorderSizePixel = 0,
                        ZIndex = 21
                    })
